...
export default async function AdminDashboard() {
    ...
    const stats = [
        {
            label: 'Productos', valor: totalProductos, bgLight: 'bg-blue-50',
        ...
        {
            label: 'Categorías', valor: totalCategorias, bgLight: 'bg-amber-50',
        ...
        {
            label: 'Servicios', valor: totalServicios, bgLight: 'bg-green-50',
                ...
                {stats.map((stat) => (
                    <div key={stat.label} className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                        <div className="flex items-center gap-4">
                            <div className={`w-12 h-12 rounded-xl ${stat.bgLight} flex items-center justify-center`}>{stat.icon}</div>
                            <div>
